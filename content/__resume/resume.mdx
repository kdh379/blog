...
이전 사용하던 Tistory 블로그를 Next.js로 마이그레이션하여 운영 중입니다.
Shadcn UI와 TailwindCSS를 활용하여 블로그 디자인을 직접 구현하였습니다.
MDX를 사용하여 블로그 포스트를 작성하고, Vercel로 배포하고 있습니다.
Google 검색을 통해 접근할 수 있도록 SEO, 웹 표준 준수와 웹 접근성을 고려하여 개발하였습니다.
